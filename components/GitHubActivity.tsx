...
const GithubSvg = ({ size = 24, color = "#64748B" }: { size?: number; color?: string }) => (
...
const stats = [
  { label: "Public Repos", value: "18+", color: "#64FFDA" },
  { label: "Total Commits", value: "600+", color: "#7B9EFF" },
...
export default function GitHubActivity() {
  return (
    <section
      id="github-activity"
      style={{ padding: "100px 0", borderTop: "1px solid #1E293B" }}
    >
      <div className="section-container">
        <div style={{ marginBottom: "48px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
            ...
            <GithubSvg size={24} color="#64748B" />
          </div>
        ...
        >
          ...
          <div className="card" style={{ padding: "24px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "20px" }}>
              <GithubSvg size={18} color="#64FFDA" />
              ...
              {topLangs.map((lang) => (
                <div key={lang.name}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px" }}>
                    <span style={{ fontSize: "0.875rem", color: "#CBD5E1", fontWeight: 500 }}>{lang.name}</span>
